package com.rais.app.my_uts_app;
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void buka(View view) {
        String url = "https://raisgroup.my.id";
    ...
    public void btnKirim(View v) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"rais14@mhs.pelitabangsa.ac.id"});
        intent.putExtra(Intent.EXTRA_CC, new String[]{"raissaputra@gmail.com"});
